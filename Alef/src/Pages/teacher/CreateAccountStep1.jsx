...
import "../../styles/tstyle/CreateAccountStep1.css";
      ...
      <div className="content">
        ...
        <form className="tutorform">
          <div className="tutorinputs">
            <div>
              <label className="toturlabels" htmlFor="firstname">
            ...
            <div>
              <label className="toturlabels" htmlFor="lastname">
          ...
          <div className="tutorinputs">
            <div>
              <label className="toturlabels" htmlFor="phonenumber">
            ...
            <div>
              <label className="toturlabels" htmlFor="tutoremail">
          ...
          <div className="tutorinputs">
            <div>
              <label className="toturlabels" htmlFor="tutorpassword">
            ...
            <div>
              <label className="toturlabels" htmlFor="coniformtutorpassword">
